...
function Install-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Install' -FilePath 'PatchMyPC-Publishing-Service-2.1.110.4 (2).msi' -AdditionalArgumentList '/QN REBOOT=ReallySuppress'
...
function Uninstall-ADTDeployment
{
    ...
    Start-ADTMsiProcess -Action 'Uninstall' -FilePath ' {DB6DB066-68E6-42F6-A659-1344346B7026}'
